...
namespace _16_RecentItems
{
    public partial class Form8 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dlg.Font = new System.Drawing.Font("BCCcodePGMF", 30);
            ...
            if (dlg.ShowDialog() == DialogResult.OK)
            {
                ...
                gt.DrawString(Program.Globals.text, new System.Drawing.Font(dlg.Font.Name, dlg.Font.Size), Brushes.Green, new PointF(-(textplot.Width - leftw - 2) + 3, -righth));
                ...
                for (int y = 1; y <= textplott.Height; ++y)
                {
                    for (int x = 1; x <= textplott.Width; ++x)
                    {
                        ...
                        int posp1 = (y - 1 + (int)(Program.Globals.yy / 3)) * (int)(Program.Globals.sx * 4) + (x - 1 + (int)(Program.Globals.xx / 3));
                        if (posp1 < Program.Globals.sx * Program.Globals.sy * 16 && colorIndex != 0)
                        {
