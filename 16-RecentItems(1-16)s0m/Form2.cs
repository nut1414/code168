...
namespace _16_RecentItems
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if ((uint)numericUpDown1.Value < 1 || (uint)numericUpDown2.Value < 1 || (uint)numericUpDown1.Value > 220 || (uint)numericUpDown2.Value > 220)
            {
                MessageBox.Show("Must be more than 1x1 or lower than 220x220.");
            }
            else
            {
