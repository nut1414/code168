    ...
    public partial class Form1 : Form
    {
                ...
                if (Program.Globals.savechange == true)
                {
                    if (Program.Globals.create == true)
                    {
                        ...
                        if (result2 == DialogResult.Yes)
                        {
                            ...
                            saveFileDialog1.FileName = "BCC_Code1.bcc1";

                            saveFileDialog1.Title = "Save!";

                            saveFileDialog1.DefaultExt = "bcc1";

                            saveFileDialog1.Filter = "bcc1 file |*.bcc1|All Files (*.*)|*.*";
                            ...
                            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                            {
                                ...
                                int takes = (int)(10*Program.Globals.sx * Program.Globals.sy);
                                int endl = (int)Program.Globals.sx; string results = "";
                                for (int k = 0; k < Program.Globals.maxpage; k++)
                                {
                                    for (int i = 0; i < Program.Globals.sy; i++)
                                    {
                                        for (int j = 0; j < Program.Globals.sx; j++)
                                        {
                                            results += Program.Globals.level1[i * (Program.Globals.sx) + j, k+1] + "\r\n";
                                        }
                                    }
                                }
                                string type = (Program.Globals.sx + System.Environment.NewLine + Program.Globals.sy + System.Environment.NewLine);
                                System.IO.File.WriteAllText(saveFileDialog1.FileName, type + results);
                                Application.Exit();
                            }
            ...
            if (Program.Globals.savechange == true)
            {
                if (Program.Globals.create == true)
                {
                    ...
                    if (result2 == DialogResult.Yes)
                    {
                        ...
                        saveFileDialog1.DefaultExt = "bcc16";
        ...
        void _ButtonSaveAs_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            if (Program.Globals.frm.Text != "CODE 163!")
            {
                ...
                string type = (Program.Globals.sx + System.Environment.NewLine + Program.Globals.sy + System.Environment.NewLine);
                System.IO.File.WriteAllText(Program.Globals.fcurrent,type + results);
        ...
        void _Preview_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            ...
            ex = new Bitmap((int)Program.Globals.sx, (int)Program.Globals.sy);
            ...
            for (int y = 1; y <= ex.Height; ++y)
            {
                for (int x = 1; x <= ex.Width; ++x)
                {
                    ...
                    if (Program.Globals.level[posp] > 12)
                    {
                        Program.Globals.level[posp] = 12;
                    }
                    
                    ex.SetPixel(x - 1, y - 1, _colors[Program.Globals.level1[posp,Program.Globals.page]]);
                }
            }
        ...
        void _Export_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            ...
            System.Drawing.Color[] _colors = new System.Drawing.Color[8];
            for (int i = 0; i < 8; i++)
            {
                int red = int.Parse(Program.Globals.getco[i].Substring(0, 2), NumberStyles.AllowHexSpecifier);
                int green = int.Parse(Program.Globals.getco[i].Substring(2, 2), NumberStyles.AllowHexSpecifier);
        ...
        {
            if (Program.Globals.fcontrol == null)
            {
                Program.Globals.fcontrol = new Form10();
                Program.Globals.fcontrol.FormClosed += delegate { Program.Globals.fcontrol = null; };
                Program.Globals.fcontrol.Show(Program.Globals.frm);
            }
            else
                Program.Globals.fcontrol.BringToFront();
        }
        /* 
         void _Openshut_ExecuteEvent(object sender, ExecuteEventArgs e)
         {
             ...
             this.Cursor = textcur;
                 ...
                 Form10 fcontrol = new Form10();
                     fcontrol.Show(Program.Globals.frm);
        ...
        void _excel_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            ...
            {
                Program.Globals.level1[k - 1,Program.Globals.page] = (uint)Program.Globals.curcolor;
            }
                ...
                if (Program.Globals.create == true)
                {
                    ...
                    if (result2 == DialogResult.Yes)
                    {
                        ...
                        if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            string type = (Program.Globals.sx + System.Environment.NewLine + Program.Globals.sy + System.Environment.NewLine);
                            System.IO.File.WriteAllText(saveFileDialog1.FileName, "Line:594\n" + type + results);
        ...
        void _ButtonSave_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                int endl = (int)Program.Globals.sx;
                string results = "";
                Console.Write("maxpage: " + Program.Globals.maxpage + "\r\n");
                for (int k = 0; k < Program.Globals.maxpage; k++)
                {
                    for (int i = 0; i < Program.Globals.sy; i++)
                    {
        ...
        void _ButtonOpen_ExecuteEvent(object sender, ExecuteEventArgs e)
        {
            if (Program.Globals.savechange == false)
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    uint boardsize = Program.Globals.sx * Program.Globals.sy ;
                    int page = 1;
                    int posk = 1;
                    for (int k = 1; k <= (getload.Length-2); k++)
                    {
                        Program.Globals.level1[posk - 1,page] = (uint)Convert.ToInt32(getload[k + 1]);
                        //Console.Write("k : " + k + " , " + "page: " + page + "level1: " + Program.Globals.level1[k - 1, page]  + "\r\n");
                        if (k % boardsize == 0)
                        {
                            posk = 1;
                            page++;
                    ...
                    Program.Globals.maxpage = page-1;
                    for (int k = 0; k < boardsize; k++)
                    {
                        Program.Globals.levelshow[k] = Program.Globals.level1[k, 1];
                    }
                    /*
                    
                    //int last = (int)Program.Globals.sx * (int)Program.Globals.sy;
                    //This is use for  1 : 16
                    ...
                    */
                    ...
                    //Program.Globals.map.load("tileset.png", Program.Globals.tiless, Program.Globals.levelshut, Program.Globals.sx, Program.Globals.sy);
                    Program.Globals.create = true;
                    Program.Globals.loadd = true;
            ...
            if (Program.Globals.savechange == true)
            {
                Console.Write("Function open with savechange == true have been activated\r\n");
                if (Program.Globals.create == true)
                {
                    DialogResult result2 = MessageBox.Show("Do you want to save changes?", "Save Changes?", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
                    if (result2 == DialogResult.Yes)
                    {
                        ...
                        if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            for(int k = 0; k < Program.Globals.maxpage; k++)
                            {
                                for(int i = 0; i < Program.Globals.sx; i++)
                                {
                                    for(int j = 0; j < Program.Globals.sy; j++)
                                    {
                                        results += Program.Globals.level1[i * (Program.Globals.sx) + j, k + 1] + "\r\n";
                                    }
                                }
                        ...
                        if (result == DialogResult.OK)
                        {
                            ...
                            Program.Globals.sx = (uint)Convert.ToInt32(getload[0]);
                            Program.Globals.sy = (uint)Convert.ToInt32(getload[1]);
                            int last = (int)(Program.Globals.sx * Program.Globals.sy);
                            for (int k = 1; k <= Program.Globals.sx * Program.Globals.sy; ++k)
                            {
                                Program.Globals.level1[k - 1,Program.Globals.page] = (uint)Convert.ToInt32(getload[k + 1]);
                            }
                            /*
                            for (int k = last + 3; k <= (last + 2 + Program.Globals.sx * Program.Globals.sy); ++k)
                            {
