...
namespace _16_RecentItems
{
    ...
    {
        PictureBox[] pictureBox = new PictureBox[41];
        Label[] textt = new Label[41];
        Label[] numm = new Label[41];
        public Label nowcolor = new Label();
        string[] al = new string[41] { "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "A", "S", "D", "F", "G", "H", "J", "K", "L", ";", "Z", "X", "C", "V", "B", "N", "M", ",", ".", "/", "+" };
        public Form3()
        {
            Program.Globals.getco = System.IO.File.ReadAllLines(@"1-16.palette");
            this.TopLevel = true;
            InitializeComponent();
            ...
            for (int i = 0; i < 41; i++)
            {
                ...
                {
                    pictureBox[i].Location = new Point((i - 40) * 37, 158);
                }
